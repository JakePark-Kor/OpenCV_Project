...
# 허프 변환 원 검출
circles = cv2.HoughCircles(blr, cv2.HOUGH_GRADIENT, 1 , 50, param1 = 150, 
                            param2= 40, minRadius = 20, maxRadius = 80  )
                            #param2 = ThreadHold
                            #param1 = canny edge detection
...
if circles is not None:
    for i in range(circles.shape[1]):
        ...
        hue, _, _ = cv2.split(hsv) # hue, saturation, value로 나눠짐
        ...
        cv2.putText(crop, str(won), (10, 50), cv2.FONT_HERSHEY_SIMPLEX,
